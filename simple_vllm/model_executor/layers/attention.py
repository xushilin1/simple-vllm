...
from simple_vllm import attention_ops
from simple_vllm import cache_ops
from simple_vllm import pos_encoding_ops
...
class PagedAttention(nn.Module):
    ...
    def multi_query_kv_attention(
        ...
        query_reshaped = query.transpose(0, 1).unsqueeze(0)  # [1, num_heads, seq_len, head_dim]
        key_reshaped = key.transpose(0, 1).unsqueeze(0)      # [1, num_heads, seq_len, head_dim]
        value_reshaped = value.transpose(0, 1).unsqueeze(0)  # [1, num_heads, seq_len, head_dim]
        ...
        # Reshape back to original format: [seq_len, num_heads, head_dim]
